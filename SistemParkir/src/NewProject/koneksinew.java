...
//variabel yang di butuhkan
	 ...
	 public static void main(String args[]){
		 ...
		 conn = DriverManager.getConnection("jdbc:mysql://localhost/uasparkir","root","");//database,username,password disesuaikan
	 ...
	 public void closeConnMysql() {
		 ...
		 Logger.getLogger(koneksinew.class.getName()).log(Level.SEVERE, null, ex);
		 }
